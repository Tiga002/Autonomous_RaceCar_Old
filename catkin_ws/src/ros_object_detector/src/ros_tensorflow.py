...
class ros_tensorflow_obj():
	def __init__(self):
		...
		# What model to grun
                ...
                MODEL_PATH = os.path.join(os.path.dirname(sys.path[0]),'include','ros_object_detector',MODEL_NAME)
		...
		# List of the strings that is used to add correct label for each box.
                ...
                PATH_TO_LABELS = os.path.join(os.path.dirname(sys.path[0]),'include','ros_object_detector','ssd_mobilenet_v1_coco_11_06_2017',LABEL_NAME)
		...
		NUM_CLASSES = 90 # As defined in labels file
